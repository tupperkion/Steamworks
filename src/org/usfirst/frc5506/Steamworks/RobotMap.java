...
public class RobotMap {
    ...
    public static SpeedController conveyorConveyor;
    ...
    public static void init() {
        ...
        conveyorConveyor = new Spark(3);
        LiveWindow.addActuator("Conveyor", "Conveyor", (Spark) conveyorConveyor);
        
        conveyorConveyorSwitch = new DigitalInput(1);
